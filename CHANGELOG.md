...
- `fanhub-workshop` v1.0.0 — complete APM package for the FanHub `.NET` Breaking Bad workshop track
  ...
  - Module 01: `.apm/instructions/copilot-instructions.instructions.md` → deployed to `.github/copilot-instructions.md` via `apm run install-docs`; also compiles into `AGENTS.md`/`CLAUDE.md` via `apm compile`
